...
dtc_smote_model = load_model('models_fraud/DecisionTreeClassifier-SMOTE.pkl')
gnb_smote_model = load_model('models_fraud/GaussianNB-SMOTE.pkl')
rfc_smote_model = load_model('models_fraud/RandomForestClassifier-SMOTE.pkl')
xgb_smote_model = load_model('models_fraud/XGBClassifier-SMOTE.pkl')
voting_model = load_model('models_fraud/VotingClassifier-voting.pkl')
...
def make_fraud_predictions(input_df, input_dict):
  ...
  rfc_smote_predict = rfc_smote_model.predict_proba(input_df)[0][1],
  ...
  rfc_smote_predict = rfc_smote_predict[0]
  ...
  if rfc_smote_predict >= min_threshold: probabilities['Random Forest (SMOTE)'] = rfc_smote_predict
